...
export const SignupForm: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-3xl border border-[#E2E8E4] p-8 sm:p-10 shadow-sm text-left">
      {/* Header */}
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-[#17201A] tracking-tight">Create your account</h2>
      ...
      <div className="flex items-center gap-2 mb-6">
        <div className={`h-1.5 flex-1 rounded-full ${step >= 1 ? 'bg-[#166534]' : 'bg-slate-200'}`} />
        <div className={`h-1.5 flex-1 rounded-full ${step >= 2 ? 'bg-[#166534]' : 'bg-slate-200'}`} />
        <div className={`h-1.5 flex-1 rounded-full ${step >= 3 ? 'bg-[#166534]' : 'bg-slate-200'}`} />
      </div>
        ...
        <form onSubmit={handlePhoneSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#647067] text-sm font-medium">
                +91
              </span>
              <input
                type="tel"
                ...
                autoFocus
                className="w-full py-3 pl-14 pr-4 bg-white border border-[#E2E8E4] rounded-xl text-sm text-[#17201A] placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#166534] focus:border-transparent transition-all"
              />
            </div>
          ...
          <div className="pt-4 text-center text-xs text-[#647067]">
            ...
            <Link to="/login" className="text-[#166534] font-bold hover:underline">
              Login here
            </Link>
          </div>
        </form>
      ...
      {step === 3 && (
        <form onSubmit={handleProfileSubmit} className="space-y-4">
          <div>
            <label className="text-xs font-bold text-[#17201A] uppercase tracking-wider block mb-1">
              Full Name
            </label>
            <input
              type="text"
              ...
              autoFocus
              className="w-full py-2.5 px-3.5 bg-white border border-[#E2E8E4] rounded-xl text-sm text-[#17201A] focus:outline-none focus:ring-2 focus:ring-[#166534]"
            />
          </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full py-2.5 px-3 bg-white border border-[#E2E8E4] rounded-xl text-xs text-[#17201A] focus:outline-none focus:ring-2 focus:ring-[#166534]"
                  >
            ...
            <>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full py-2.5 px-3.5 bg-white border border-[#E2E8E4] rounded-xl text-xs text-[#17201A] focus:outline-none focus:ring-2 focus:ring-[#166534]"
                />
              </div>
